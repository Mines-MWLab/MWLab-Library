...
#####################################################################################
# Author: Julian Laverde, TAU 2025
# Double layer inverse taper for edge coupler
#####################################################################################
...
@gf.cell
def double_taper_edge_coupler_JL(
    slab_tip_length: float = 10.0,
    slab_taper_length: float = 400.0,
    ...
    if ridge_end_x < slab_end_x:
        ...
        ridge_extension = gf.components.taper_cross_section(
            cross_section1=partial(xs_ridge, width=ridge_width_end),
            cross_section2=partial(xs_ridge, width=ridge_width_end + 1.0),
